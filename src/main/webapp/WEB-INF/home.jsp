...
<h5>젠킨스 배포 모두 성공 했나요? 참 쉽~~~죠잉!!!!</h5>
<h4>자동빌드 테스트</h4>
<div>
    <textarea style="width: 100%; height: 120px;" class="form-control" id="msg"> 프로젝트 잘 징행되고 있어요?</textarea>
</div>
...
<script type="text/javascript">
    ...
    $(".voicespeak").click(function (){
        ...
        // 선택한 나라 기호
        let lang=$("#seltrans").val();
        if(lang=='en'||lang=='ja'||lang=='zh-CH'||lang=='es'||lang=='ko'){
        $.ajax({
            type:"get",
            url:"./voice",
            data:{"msg":msg,"lang":lang},
            dataType:"text",//mp3파일명반환
            success:function(res){
                //alert(res);
        ...
        alert("현재 영어, 중국어, 일어, 스페인어만 목소리를 지원하고 있습니다.");
        }
    });
</script>
</body>
